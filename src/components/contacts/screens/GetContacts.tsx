  ...
  return (
    <View style={[a.h_full]}>
      <Layout.Content
        ...
        <Text style={style}>
          <Trans>
            One helps friends find each other by creating an encoded digital
      ...
      <View
        ...
        <Text style={[a.text_sm, a.pb_xs]}>
          <Trans>
            I consent to One using my contacts for mutual friend discovery and
...
function showPermissionDeniedAlert() {
  Alert.alert(
    ...
    t`You'll need to go to the System Settings for One and give permission if you want to use this feature.`,
    [
      {
        text: t`OK`,
        style: 'default',
